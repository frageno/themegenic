    ...
    <?php if(have_rows('cards')): ?>
        <div class="max-w-screen-xl px-5 py-32 mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md">
                ...
                ?>
                    <div class="p-md teaser-card bg-white shadow-xl border-b-2 border-transparent hover:border-b-2 hover:border-primary flex flex-col items-center justify-center text-center rounded-3xl transition-all duration-300">
                        <?php if($image): ?>
                            <div class="image">
